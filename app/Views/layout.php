...
<div class="app">
  ...
  <aside class="sidebar">
    ...
    <a href="dashboard.html" class="nav-item" style="display:none">
    ...
    <a href="<?= base_url('/liste-etudiants') ?>" class="nav-item">
    ...
    <div class="sidebar-section" style="display:none">Modules</div>
    ...
    <div class="sidebar-section" style="display:none">Système</div>
